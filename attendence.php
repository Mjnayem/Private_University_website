...
if($coursecode!=""&&$numberofstudent!=""&&$dept!=""&&$date_sl!=""){
  
  mysqli_query($conn,"INSERT into attandence (semester,date_at,course_code,email_teacher,dept,number_student) values ('$semester','$date_sl','$coursecode','$email','$dept','$numberofstudent')");

 ?>
  <script>
  swal('Yes ','Uploaded .','success');
  </script>
  <?php
...
<div class="col-md-6 dd">
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Presented Students </span>
  <input type="text" class="form-control" placeholder="Number of Students" aria-describedby="sizing-addon1" name="numberofstudent">
</div>
</div>
</div>
...
<div class="input-group input-group-lg">
  ...
  <input type="text" class="form-control" placeholder="2017-08-20" aria-describedby="sizing-addon1" name="date_sl">
</div>
</div>
